document.addEventListener('DOMContentLoaded', () => {
    ...
    const WEB_APP_URL = 'https://script.google.com/macros/s/AKfycbwh1nHv-utUNPuHUA30YXfziK4hV0ILnL63YN8qrgLwS2LvfJhrfAfotwUvhF1fZrO7yw/exec';
    ...
    const addRecordToDOM = (record) => {
        ...
        const typeText = { 'korea': '한식 🍚', 'china': '중식 🍜' , 'japan': '일식 🍣' , 'italy': '양식 🍝' , 'aa': '기타 🥪' };
